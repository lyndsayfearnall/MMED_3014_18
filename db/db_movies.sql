...
--
-- Host: localhost:8889
-- Generation Time: Feb 22, 2018 at 03:01 PM
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_level`, `user_ip`, `login_attempts`) VALUES
(1, 'Lyndsay', 'Fearnall', 'test', 'lyndsay.fearnall@gmail.com', '2018-02-22 03:26:24', '', '::1', 0),
(24, 'Johnny', 'testUser', 'test', 'test@test.com', '2018-02-22 08:34:53', '1', '::1', 0),
(26, 'Lynda', 'listenLynda', 'rWTnX1', 'listenLynda@gmail.com', '2018-02-22 00:41:22', '2', 'no', 0),
(33, 'test', 'test', 'test', 'test', '2018-02-22 13:18:12', '1', 'no', 0);
...
--
ALTER TABLE `tbl_user`
  MODIFY `user_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
